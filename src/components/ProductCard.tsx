    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          {product.store?.name && (
            <div className="text-sm text-gray-500">by {product.store.name}</div>
          )}
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          {showAddCart && <button
            ...
            } text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 flex items-center justify-center`}
          >
            {product.stock <= 0 ? (
              "Out of Stock"
            ) : isAddingToCart ? (
